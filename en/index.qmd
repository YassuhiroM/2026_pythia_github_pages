...
[Project Document](../assets/docs/project-document.pdf){.cta-button .cta-secondary}
:::
:::
...
<div class="detail-visual-frame">
  <img class="detail-visual" src="../assets/images/project-details/revenue_plot.svg" alt="Daily total revenue and 7-day moving average, with a EUR 1,000 reference line (2019-2025).">
</div>
```
...
```{=html}
<div class="detail-visual-frame">
  <img class="detail-visual" src="../assets/images/project-details/table-1.png" alt="Prophet vs. Linear Regression vs. XGBoost on the full 2025 test set.">
</div>
```
...
```{=html}
<div class="detail-visual-frame">
  <img class="detail-visual" src="../assets/images/project-details/table-3.png" alt="Production evaluation metrics for Prophet models, January 2026.">
</div>
```
...
```{=html}
<div class="detail-visual-frame">
  <img class="detail-visual" src="../assets/images/project-details/figure-8-text-mining-streamlit.png" alt="Screenshot of the Pythia app review analysis module.">
</div>
```
...
::: {.team-list}
<div class="team-item"><span>Anabel Baez Rodriguez</span><a class="icon-link" href="https://www.linkedin.com/in/anabel-baez-996348a4/" aria-label="Anabel Baez Rodriguez on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
<div class="team-item"><span>Fatima Tawfik Vazquez</span><a class="icon-link" href="https://www.linkedin.com/in/fatimatawfikvazquez/" aria-label="Fatima Tawfik Vazquez on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
<div class="team-item"><span>Genesis Hernandez Gallegos</span><a class="icon-link" href="https://www.linkedin.com/in/genesishernandezg/" aria-label="Genesis Hernandez Gallegos on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
<div class="team-item"><span>Ilan Arvelo Yagua</span><a class="icon-link" href="https://www.linkedin.com/in/ilan-arvelo-yagua/" aria-label="Ilan Arvelo Yagua on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
<div class="team-item"><span>Luca Iacomino</span><a class="icon-link" href="https://www.linkedin.com/in/luca-iacomino-58440b180/" aria-label="Luca Iacomino on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
<div class="team-item"><span>Marcio Yassuhiro</span><a class="icon-link" href="https://www.linkedin.com/in/yassuhiro-m/" aria-label="Marcio Yassuhiro on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
:::
:::
