...
<div class="detail-visual-frame">
  <img class="detail-visual" src="../assets/images/project-details/figure-1-time-series.png" alt="Daily total revenue and 7-day moving average, with a EUR 1,000 reference line (2019-2025).">
</div>
```
