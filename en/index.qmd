...
::: {.hero-skills}
[]{.skill-chip} CRISP-DM
[]{.skill-chip} ETL / Data Preparation
[]{.skill-chip} Exploratory Data Analysis
[]{.skill-chip} Feature Engineering
[]{.skill-chip} Time-Series Forecasting
[]{.skill-chip} Prophet
[]{.skill-chip} NLP / Text Mining
[]{.skill-chip} YAKE
[]{.skill-chip} Sentence-BERT
[]{.skill-chip} Model Evaluation
[]{.skill-chip} Competitive Benchmarking
[]{.skill-chip} Streamlit Deployment
:::
...
<div class="team-item"><span>Yassuhiro Marcio</span><a class="icon-link" href="https://www.linkedin.com/in/yassuhiro-m/" aria-label="Yassuhiro Marcio on LinkedIn"><img src="../assets/images/linkedin-icon.svg" alt=""></a></div>
:::
:::
